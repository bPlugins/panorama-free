...
const welcomeInfo = adminUrl => ({
  ...
  changelogs: [{
    ...
    list: ['<strong>New:</strong> 360° Interaction Analytics Dashboard for monitoring viewer impressions, hotspot clicks, and view durations (7-Day Overview).', '<strong>New:</strong> Added Cubemap (6-Face Box Projection) & Cylindrical (Smartphone Panoramas) 360 projection formats.', '<strong>New:</strong> Expanded Free Virtual Tour limit to 6 scenes per tour (previously 2 scenes).', '<strong>New:</strong> Unlocked Gyroscope / Device Motion Tilt navigation control in the Free tier.', '<strong>New:</strong> Unlocked Set Default / Initial View (FOV, Pitch & Yaw orientation) in the Free tier.']
  }, {
    type: 'new',
    version: '1.7.4 - 11 July, 2026',
    list: ['<strong>New:</strong> Added Link, Image, and Video hotspot support inside 360 Virtual Tours with aligned setup popups and media uploader type restrictions.', '<strong>Improved:</strong> Upgraded WooCommerce Product editor metabox fields (Panorama Settings) with meaningful help descriptions and modern copy-badge clipboard layouts.', '<strong>Improved:</strong> Optimized Product Spot layouts (Simple, Tippy, Sidepanel) with enhanced Sidepanel ratios and reliable AJAX saving.']
  }],
  changelogsLimit: 2,
  changelogsReadMoreLabel: 'View More Changelogs',
  proFeatures: ['360° Interaction Analytics Dashboard with impression logs, click stats, and conversion metrics.', 'Interactive WooCommerce Product Hotspots with price badges and instant Add to Cart.', 'WooCommerce Single Product 360° Video & custom gallery placement options.', 'Unlimited Multi-Scene Virtual Tours with rich Image, Video, and Product hotspots.', 'Preview Cover Image with custom load button for faster page loading speed.', 'Auto-Rotate Inactivity Delay resume and customizable panning speeds.', 'Responsive Panorama Gallery & Grid layouts with Load More pagination.', 'Interactive Compass Overlay, Kiosk Exhibition Lock, and custom player buttons.', '360° Video Picture-in-Picture mode and playback speed controls (0.5x to 2x).', 'External CDN & Direct URL support for remote image and video hosting.']
});
