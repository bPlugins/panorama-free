...
/***/ "./src/blocks/gallery/Components/Common/GalleryViewer.js":
/*!***************************************************************!*\
  !*** ./src/blocks/gallery/Components/Common/GalleryViewer.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_icons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/icons */ "./src/blocks/gallery/utils/icons.js");
...
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\gallery\\Components\\Common\\GalleryViewer.js",
  _this = undefined;
...
var GalleryViewer = function GalleryViewer(_ref) {
  var _galleries$currentIte;
  var attributes = _ref.attributes,
    setAttributes = _ref.setAttributes,
    _ref$isButton = _ref.isButton,
    isButton = _ref$isButton === void 0 ? false : _ref$isButton;
  var galleryContainerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  var panoramaContainerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  var mainContainerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  var _ref2 = attributes || {},
    _ref2$galleries = _ref2.galleries,
    galleries = _ref2$galleries === void 0 ? [] : _ref2$galleries,
    _ref2$galleryLimit = _ref2.galleryLimit,
    galleryLimit = _ref2$galleryLimit === void 0 ? 2 : _ref2$galleryLimit,
    gap = _ref2.gap,
    _ref2$loadMoreBtn = _ref2.loadMoreBtn,
    loadMoreBtn = _ref2$loadMoreBtn === void 0 ? {} : _ref2$loadMoreBtn;
  ...
  var totalPages = Math.ceil(galleries.length / galleryLimit);
  var currentItems = galleries.slice(0, currentPage * galleryLimit);

  // Open Panorama (Image / Video)
  var openPanorama = function openPanorama(item, index) {
    var _item$initialPosition;
    var _window = window,
    ...
    panoramaRef.current = item.isSetVideo ? new PANOLENS.VideoPanorama(item.video, {
      autoplay: true,
      muted: false
    ...
    var zoomLevel = item.fov || ((_item$initialPosition = item.initialPosition) === null || _item$initialPosition === void 0 ? void 0 : _item$initialPosition.fov) || 85;
    viewerRef.current.camera.fov = zoomLevel;
    viewerRef.current.camera.updateProjectionMatrix();
    if (item.initialPosition) {
      var _item$initialPosition2 = item.initialPosition,
        x = _item$initialPosition2.x,
        y = _item$initialPosition2.y,
        z = _item$initialPosition2.z;
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (viewerRef.current && viewerRef.current.camera && currentItemIndex !== null && galleries[currentItemIndex]) {
      var currentFov = galleries[currentItemIndex].fov || 85;
  ...
  // Close Panorama
  var closePanorama = function closePanorama() {
  ...
  var handleSetInitialView = function handleSetInitialView() {
    if (viewerRef.current && viewerRef.current.camera && currentItemIndex !== null) {
      ...
      var fov = camera.fov;
      var newGalleries = (0,immer__WEBPACK_IMPORTED_MODULE_6__.produce)(galleries, function (draft) {
        draft[currentItemIndex].initialPosition = {
          x: x,
          y: y,
          z: z,
          fov: fov
      ...
      react_toastify__WEBPACK_IMPORTED_MODULE_4__.toast.success("Initial view and zoom set successfully for this gallery item!", {
        position: "bottom-center"
      });
    }
  };
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(react_toastify__WEBPACK_IMPORTED_MODULE_4__.ToastContainer, {
    __self: _this,
    __source: {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: function onClick() {
        return openPanorama(item, (currentPage - 1) * galleryLimit + index);
      },
      __self: _this,
      __source: {
        fileName: _jsxFileName,
    ...
    }, item.isSetVideo && /*#__PURE__*/React.createElement("span", {
  ...
  })), galleries.length > currentPage * galleryLimit && /*#__PURE__*/React.createElement("div", {
  ...
  }, (loadMoreBtn === null || loadMoreBtn === void 0 ? void 0 : loadMoreBtn.text) || "Load More")), /*#__PURE__*/React.createElement("div", {
  ...
  }, isButton && ((_galleries$currentIte = galleries[currentItemIndex]) === null || _galleries$currentIte === void 0 ? void 0 : _galleries$currentIte.initialView) && /*#__PURE__*/React.createElement("button", {
    style: {
      position: "absolute",
      top: "5px",
      right: "60px",
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Set as Initial View", "panorama")), /*#__PURE__*/React.createElement("p", {
  ...
  }, _utils_icons__WEBPACK_IMPORTED_MODULE_1__.closeIcon)), /*#__PURE__*/React.createElement("div", {
    id: "bppiv-main-container",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GalleryViewer);

/***/ }),

/***/ "./src/blocks/gallery/Components/Common/Style.js":
/*!*******************************************************!*\
  !*** ./src/blocks/gallery/Components/Common/Style.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\gallery\\Components\\Common\\Style.js",
  _this = undefined;

var Style = function Style(_ref) {
  var attributes = _ref.attributes,
    id = _ref.id;
  var loadMoreBtn = attributes.loadMoreBtn,
    column = attributes.column;
  var colors = loadMoreBtn.colors,
    hoverColors = loadMoreBtn.hoverColors;
  var mainSl = "#".concat(id);
  var blockSl = "".concat(mainSl, " .bBlocksGalleryViewer");
  var loadMoreBtnSl = "".concat(blockSl, " .pan_loadMore");
  var galleryConSl = "".concat(blockSl, " .galleryCon");
  return /*#__PURE__*/React.createElement("style", {
    dangerouslySetInnerHTML: {
      __html: "\n\n            ".concat(galleryConSl, "{\n              grid-template-columns: repeat(").concat(column, ", 2fr);\n            }\n            ").concat(loadMoreBtnSl, "{\n              ").concat((0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_0__.getColorsCSS)(colors), "\n            }\n\n            ").concat(loadMoreBtnSl, ":hover{\n              ").concat((0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_0__.getColorsCSS)(hoverColors), "\n            }\n\n            @media only screen and (min-width:641px) and (max-width: 1024px){\n              ").concat(galleryConSl, "{\n                grid-template-columns: repeat(2, 2fr);\n              }\n          }\n\n          @media only screen and (max-width:640px){\n            ").concat(galleryConSl, "{\n              grid-template-columns: repeat(1, 2fr);\n            }\n          }\n\n\t        ")
    },
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
/***/ "./src/blocks/gallery/utils/icons.js":
/*!*******************************************!*\
  !*** ./src/blocks/gallery/utils/icons.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\gallery\\utils\\icons.js";
var iconColor = "#4527a4";
var blockIcon = /*#__PURE__*/React.createElement("svg", {
  className: "panorama-block-icon",
  stroke: "currentColor",
  fill: iconColor,
  strokeWidth: 0,
  viewBox: "0 0 512 512",
...
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/gallery/Components/Common/Style.js");
/* harmony import */ var _Components_Common_GalleryViewer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/Common/GalleryViewer */ "./src/blocks/gallery/Components/Common/GalleryViewer.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/gallery/style.scss");
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\gallery\\view.js",
  _this = undefined;
...
document.addEventListener("DOMContentLoaded", function () {
  var PanoramicImageViewerEls = document.querySelectorAll(".wp-block-panorama-gallery");
  PanoramicImageViewerEls.forEach(function (PanoramicImageViewerEl) {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_0__.createRoot)(PanoramicImageViewerEl).render(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_1__["default"], {
      ...
      className: "bBlocksGalleryViewer",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 17,
    ...
    }, /*#__PURE__*/React.createElement(_Components_Common_GalleryViewer__WEBPACK_IMPORTED_MODULE_2__["default"], {
      attributes: attributes,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
