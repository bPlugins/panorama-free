...
/***/ "./src/blocks/tour/Components/Common/Style.js":
/*!****************************************************!*\
  !*** ./src/blocks/tour/Components/Common/Style.js ***!
  \****************************************************/
...
/* harmony export */ });
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\tour\\Components\\Common\\Style.js",
  _this = undefined;
...
var Style = function Style(_ref) {
  ...
  var blockSl = "".concat(mainSl, " .bBlocksTourViewer");
  var tourContainerSl = "".concat(blockSl, " .tourContainer");
  return /*#__PURE__*/React.createElement("style", {
    dangerouslySetInnerHTML: {
      __html: "\n\n          ".concat(blockSl, " { align-items: ").concat(alignSl[device], "; }\n          ").concat(tourContainerSl, " { width: ").concat(width[device], "; height: ").concat(height[device], "; }\n      \n          @media only screen and (min-width:641px) and (max-width: 1024px) {\n            ").concat(blockSl, " { align-items: ").concat(alignSl.tablet, "; }\n            ").concat(tourContainerSl, " { width: ").concat(width.tablet, "; height: ").concat(height.tablet, "; }\n          }\n      \n          @media only screen and (max-width:640px) {\n            ").concat(blockSl, " { align-items: ").concat(alignSl.mobile, "; }\n            ").concat(tourContainerSl, " { width: ").concat(width.mobile, "; height: ").concat(height.mobile, "; }\n          }\n            \n\t\t    ")
    },
    __self: _this,
    __source: {
...
/***/ "./src/blocks/tour/Components/Common/TourViewer.js":
/*!*********************************************************!*\
  !*** ./src/blocks/tour/Components/Common/TourViewer.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\tour\\Components\\Common\\TourViewer.js",
  _this = undefined;
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
...
var TourViewer = function TourViewer(_ref) {
  ...
  var tourContainerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  ...
  var _ref2 = attributes || {},
    _ref2$tour_ = _ref2.tour_360,
    tour_360 = _ref2$tour_ === void 0 ? [] : _ref2$tour_,
  ...
  var hideDefaultCtrl = options.hideDefaultCtrl,
    ...
    initialViewPosition = options.initialViewPosition,
    autoLoad = options.autoLoad,
    showFullscreenCtrl = options.showFullscreenCtrl,
    showZoomCtrl = options.showZoomCtrl,
    ...
    isByline = options.isByline;
  var _ref3 = initialViewPosition || {},
    pitch = _ref3.pitch,
    yaw = _ref3.yaw,
    hfov = _ref3.hfov;
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    for (var i = 0; i < tour_360.length; i++) {
      var _tour_360$i, _tour_360$i2, _tour_360$i3, _tour_360$i4, _tour_360$i5;
      var title = (_tour_360$i = tour_360[i]) === null || _tour_360$i === void 0 ? void 0 : _tour_360$i.title;
      var author = (_tour_360$i2 = tour_360[i]) === null || _tour_360$i2 === void 0 ? void 0 : _tour_360$i2.author;
      var isTitleAuthor = (_tour_360$i3 = tour_360[i]) === null || _tour_360$i3 === void 0 ? void 0 : _tour_360$i3.tourTitleAuthor;
      var titleAuthor = {
      ...
      var hotSpots = ((_tour_360$i4 = tour_360[i]) === null || _tour_360$i4 === void 0 ? void 0 : _tour_360$i4.tour_hotSpot) && {
        hotSpots: [{
          pitch: -0.6,
          yaw: 37.1,
          type: "scene",
      ...
      if ((_tour_360$i5 = tour_360[i]) !== null && _tour_360$i5 !== void 0 && _tour_360$i5.default_data) {
        defaultData = tour_360[i];
      }
      tour360Scenes[tour_360[i].tour_id] = _objectSpread(_objectSpread({}, titleAuthor), {}, {
        hfov: 110,
        yaw: 5,
    ...
    if (!autoLoad) {
      setTimeout(function () {
        var _tourContainerRef$cur;
        var loadBtn = (_tourContainerRef$cur = tourContainerRef.current) === null || _tourContainerRef$cur === void 0 ? void 0 : _tourContainerRef$cur.querySelector(".pnlm-load-button p");
  ...
  }, [tour_360, previewImgUrl, loadButtonText, hideDefaultCtrl, initialView, initialViewPosition, autoLoad, showFullscreenCtrl, showZoomCtrl, isRotate, autoRotateSpeed, autoRotateInactivityDelay, compass, mouseZoom, draggable, disableKeyboardCtrl, doubleClickZoom, isByline]);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_toastify__WEBPACK_IMPORTED_MODULE_1__.ToastContainer, {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 169,
  ...
  }, isButton && initialView && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    ref: buttonRef,
...
(() => {
/*!*********************************!*\
  !*** ./src/blocks/tour/view.js ***!
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/tour/Components/Common/Style.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/tour/style.scss");
/* harmony import */ var _Components_Common_TourViewer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/TourViewer */ "./src/blocks/tour/Components/Common/TourViewer.js");
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\tour\\view.js",
  _this = undefined;
...
document.addEventListener("DOMContentLoaded", function () {
  var PanoramicImageViewerEls = document.querySelectorAll(".wp-block-panorama-tour");
  PanoramicImageViewerEls.forEach(function (PanoramicImageViewerEl) {
    ...
    }, /*#__PURE__*/React.createElement(_Components_Common_TourViewer__WEBPACK_IMPORTED_MODULE_3__["default"], {
      attributes: attributes,
      isButton: false,
      __self: _this,
      __source: {
