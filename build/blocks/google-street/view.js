...
const GoogleStreetViewer = ({
  ...
  const panoramaInstance = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  }, [panoId, hideDefaultCtrl, autoRotate, autoRotateSpeed, autoRotateActivationDuration, initialView]);
  (0,_hooks_useGutenbergDragFix__WEBPACK_IMPORTED_MODULE_3__["default"])(viewerRef, viewerRef, isBackend, isSelected);
    ...
    try {
      if (viewerInstance.current) {
        const {
          ...
          y,
          z
        } = viewerInstance.current.camera.position;
        setAttributes({
          options: {
            ...options,
            initialPosition: {
  ...
  PanoramicImageViewerEls.forEach(PanoramicImageViewerEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_0__.createRoot)(PanoramicImageViewerEl).render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_1__["default"], {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_Components_Common_GoogleStreetViewer__WEBPACK_IMPORTED_MODULE_3__["default"], {
          attributes: attributes,
          isButton: false
        })
      })]
...
/******/ 		var installedChunks = {
/******/ 			"blocks/google-street/view": 0,
/******/ 			"blocks/google-street/style-view": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/google-street/style-view"], () => (__webpack_require__("./src/blocks/google-street/view.js")))
