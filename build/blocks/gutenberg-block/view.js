  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("style", {
    dangerouslySetInnerHTML: {
      __html: `
			...
			${buttonSl}{${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_0__.getColorsCSS)(buttonColors)}}
    		${buttonSl}:hover{${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_0__.getColorsCSS)(buttonHoverColors)}}
...
/* harmony import */ var _hooks_useGutenbergDragFix__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../hooks/useGutenbergDragFix */ "./src/hooks/useGutenbergDragFix.js");
...
const ViewerOfImage = ({
  ...
  }, [url, autoRotate, rotateSpeed, autoRotateInactivityDelay, isDeviceMotion, hideControl, initialView]);
  (0,_hooks_useGutenbergDragFix__WEBPACK_IMPORTED_MODULE_3__["default"])(imageContainerRef, imageContainerRef, isBackend, isSelected);
  const handleDeviceMotionToggle = () => {
    if (!window.isSecureContext) {
      react_toastify__WEBPACK_IMPORTED_MODULE_1__.toast.warning("Device Motion requires a secure HTTPS connection!", {
        position: "top-right"
      });
      return;
    }
    if (typeof window.DeviceOrientationEvent?.requestPermission === "function") {
      window.DeviceOrientationEvent.requestPermission().then(response => {
        if (response === "granted") {
          ...
          react_toastify__WEBPACK_IMPORTED_MODULE_1__.toast.error("Permission to access motion sensors was denied.", {
            position: "top-right"
          });
        }
      }).catch(err => {
        console.error(err);
        react_toastify__WEBPACK_IMPORTED_MODULE_1__.toast.error("Failed to request permission for motion sensors.", {
          position: "top-right"
        });
      });
    } else {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(react_toastify__WEBPACK_IMPORTED_MODULE_1__.ToastContainer, {}), isDeviceMotion && device !== "desktop" && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("button", {
      className: "motionBtn",
      onClick: handleDeviceMotionToggle,
      children: isDeviceMotionActive ? "Stop Device Motion" : "Start Device Motion"
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
      ref: imageContainerRef,
      className: "bpgbPanorama",
      children: isButton && initialView && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("button", {
        ref: buttonRef,
        onClick: handleSetInitialView,
        className: "setInitialViewButton",
        children: "Set as Initial View"
      })
    }, `${url}-${autoRotate}-${rotateSpeed}-${autoRotateInactivityDelay}-${initialView}-${hideControl}-${isDeviceMotion}`)]
  });
};
...
const ViewerOfVideo = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const controlButtons = [...(fullscreen ? ["fullscreen"] : []), ...(setting ? ["setting"] : []), ...(video ? ["video"] : [])];
  ...
  (0,_hooks_useGutenbergDragFix__WEBPACK_IMPORTED_MODULE_3__["default"])(videoRef, videoRef, isBackend, isSelected);
  const handleSetInitialView = () => {
    try {
      if (viewerRef.current && viewerRef.current.camera) {
        const camera = viewerRef.current.camera;
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    ref: videoRef,
    className: "bpgbPanorama",
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(react_toastify__WEBPACK_IMPORTED_MODULE_1__.ToastContainer, {}), isButton && initialView && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("button", {
      ref: buttonRef,
      onClick: handleSetInitialView,
      className: "setInitialViewButton",
      children: "Set as Initial View"
    })]
  }, `${url}-${autoPlay}-${videoLoop}-${initialView}-${initialPosition}-${videoMute}-${hideControl}-${setting}-${fullscreen}-${video}`);
};
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  panoramaEls.forEach(panoramaEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_0__.createRoot)(panoramaEl).render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_4__["default"], {
        attributes: attributes,
        id: panoramaEl.id
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
        className: "bBlocksViewer",
        children: attributes.panoType === "image" ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Components_Common_ViewerOfImage__WEBPACK_IMPORTED_MODULE_1__["default"], {
          attributes,
          device
        }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_Components_Common_ViewerOfVideo__WEBPACK_IMPORTED_MODULE_2__["default"], {
          attributes: attributes
        })
      })]
    }));
...
/***/ "./src/hooks/useGutenbergDragFix.js":
/*!******************************************!*\
  !*** ./src/hooks/useGutenbergDragFix.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const useGutenbergDragFix = (wrapperRef, panoRef, isBackend = false, isSelected = false) => {
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    targets.forEach(({
      ...
      doc.addEventListener("touchend", handleGlobalRelease, {
        capture: true
      });
    });
    ...
    return () => {
      ...
      targets.forEach(({
        ...
        doc.removeEventListener("touchend", handleGlobalRelease, {
          capture: true
        });
      });
...
/******/ 		var installedChunks = {
/******/ 			"blocks/gutenberg-block/view": 0,
/******/ 			"blocks/gutenberg-block/style-view": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/gutenberg-block/style-view"], () => (__webpack_require__("./src/blocks/gutenberg-block/view.js")))
