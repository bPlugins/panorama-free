...
/***/ "./src/blocks/video-360/Components/Common/Style.js":
/*!*********************************************************!*\
  !*** ./src/blocks/video-360/Components/Common/Style.js ***!
  \*********************************************************/
...
/* harmony export */ });
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\video-360\\Components\\Common\\Style.js",
  _this = undefined;
var Style = function Style(_ref) {
  ...
  var blockSl = "".concat(mainSl, " .bBlocksVideo360Viewer");
  var videoConSl = "".concat(blockSl, " .panoramaVideo360Viewer");
  return /*#__PURE__*/React.createElement("style", {
    dangerouslySetInnerHTML: {
      __html: "\n\n\t\t".concat(blockSl, "{\n\t\t\talign-items: ").concat(alignSl[device], ";\n\t\t}\n\n\t\t").concat(videoConSl, "{\n\t\t\twidth: ").concat(width[device] ? width[device] : "100%", ";\n\t\t}\n\t\t\n\t\t@media only screen and (min-width:641px) and (max-width: 1024px){\n\t\t\t").concat(blockSl, "{\n\t\t\t\talign-items: ").concat(alignSl.tablet, ";\n\t\t\t}\n\n\t\t\t").concat(videoConSl, "{\n\t\t\t\twidth: ").concat(width.tablet ? width.tablet : "100%", ";\n\t\t\t}\n\n\t\t}\n\n\t\t@media only screen and (max-width:640px){\n\t\t\t").concat(blockSl, "{\n\t\t\t\talign-items: ").concat(alignSl.mobile, ";\n\t\t\t}\n\n\t\t\t").concat(videoConSl, "{\n\t\t\t\twidth: ").concat(width.mobile ? width.mobile : "100%", ";\n\t\t\t}\n\n\t\t}\n\t")
    },
    __self: _this,
    __source: {
...
/***/ "./src/blocks/video-360/Components/Common/Video360Viewer.js":
/*!******************************************************************!*\
  !*** ./src/blocks/video-360/Components/Common/Video360Viewer.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\video-360\\Components\\Common\\Video360Viewer.js",
  _this = undefined;
...
var Video360Viewer = function Video360Viewer(_ref) {
  var attributes = _ref.attributes,
  ...
  var _ref2 = options || {},
    ...
    loop = _ref2.loop,
    initialView = _ref2.initialView,
    initialPosition = _ref2.initialPosition,
    play = _ref2.play,
    progress = _ref2.progress,
    remainingTime = _ref2.remainingTime,
    volume = _ref2.volume,
    pip = _ref2.pip,
    fullscreen = _ref2.fullscreen,
    playbackSpeed = _ref2.playbackSpeed;
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (window.self !== window.top) {
      var setIframeHeight = function setIframeHeight() {
        var el = document.querySelector(".panoramaVideo360Viewer");
        if (el) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    var controlBarOptions = [].concat(_toConsumableArray(play ? ["playToggle"] : []), _toConsumableArray(remainingTime ? ["remainingTimeDisplay"] : []), _toConsumableArray(progress ? ["progressControl"] : []), _toConsumableArray(volume ? ["volumePanel"] : []), _toConsumableArray(pip ? ["pictureInPictureToggle"] : []), _toConsumableArray(fullscreen ? ["fullscreenToggle"] : []), _toConsumableArray(playbackSpeed ? ["playbackRateMenuButton"] : []));
    ...
    player.on("loadedmetadata", function () {
      ...
      if (videoEl) {
        ...
        if (videoHeight && videoWidth) {
          ...
          var container = player.el().closest(".panoramaVideo360Viewer");
  ...
  }, [autoplay, videoUrl, initialView, loop, play, progress, remainingTime, volume, pip, fullscreen, playbackSpeed]);
  var handleSetInitialView = function handleSetInitialView() {
    try {
      if (playerRef.current && playerRef.current.vr) {
        var _playerRef$current$vr = playerRef.current.vr().camera.position,
          x = _playerRef$current$vr.x,
          y = _playerRef$current$vr.y,
          z = _playerRef$current$vr.z;
        setAttributes({
  ...
  return /*#__PURE__*/React.createElement("div", {
    key: "".concat(autoplay, "-").concat(videoUrl, "-").concat(initialView, "-").concat(loop, "-").concat(play, "-").concat(progress, "-").concat(remainingTime, "-").concat(volume, "-").concat(pip, "-").concat(fullscreen, "-").concat(playbackSpeed),
  ...
  }, "Set as Initial View"), /*#__PURE__*/React.createElement("video", {
    ref: videoRef,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Video360Viewer);
...
/***/ "./src/blocks/video-360/style.scss":
/*!*****************************************!*\
  !*** ./src/blocks/video-360/style.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!**************************************!*\
  !*** ./src/blocks/video-360/view.js ***!
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _Components_Common_Video360Viewer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/Common/Video360Viewer */ "./src/blocks/video-360/Components/Common/Video360Viewer.js");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/video-360/Components/Common/Style.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/video-360/style.scss");
var _jsxFileName = "C:\\Users\\Shamim bPlugins\\Local Sites\\free-plugins-dev\\app\\public\\wp-content\\plugins\\panorama\\src\\blocks\\video-360\\view.js",
  _this = undefined;
...
document.addEventListener("DOMContentLoaded", function () {
  var PanoramicImageViewerEls = document.querySelectorAll(".wp-block-panorama-video-360");
  PanoramicImageViewerEls.forEach(function (PanoramicImageViewerEl) {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_0__.createRoot)(PanoramicImageViewerEl).render(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      className: "bBlocksVideo360Viewer",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 15,
    ...
    }, /*#__PURE__*/React.createElement(_Components_Common_Video360Viewer__WEBPACK_IMPORTED_MODULE_1__["default"], {
      attributes: attributes,
      isButton: false,
      __self: _this,
      __source: {
