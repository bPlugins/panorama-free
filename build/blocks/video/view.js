...
/***/ "./src/blocks/video/Components/Common/Style.js":
/*!*****************************************************!*\
  !*** ./src/blocks/video/Components/Common/Style.js ***!
  \*****************************************************/
...
const Style = ({
  ...
  const mainSl = `#${id}`;
  const blockSl = `${mainSl} .bBlocksVideoViewer`;
  const videoSl = `${blockSl} .panoramaVideoViewer`;
...
/***/ "./src/blocks/video/Components/Common/VideoViewer.js":
/*!***********************************************************!*\
  !*** ./src/blocks/video/Components/Common/VideoViewer.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const VideoViewer = ({
  ...
  }, [videoUrl, autoplay, loop, muted, controlBar, setting, fullscreen, video, initialView]);
  ...
  }, `${videoUrl}-${autoplay}-${loop}-${initialView}-${initialPosition}-${muted}-${controlBar}-${setting}-${fullscreen}-${video}`);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VideoViewer);

/***/ }),

/***/ "./src/blocks/video/view.js":
/*!**********************************!*\
  !*** ./src/blocks/video/view.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Components_Common_VideoViewer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/Common/VideoViewer */ "./src/blocks/video/Components/Common/VideoViewer.js");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/blocks/video/Components/Common/Style.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/video/style.scss");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__);
  ...
  PanoramicImageViewerEls.forEach(PanoramicImageViewerEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_0__.createRoot)(PanoramicImageViewerEl).render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_2__["default"], {
        ...
        className: "bBlocksVideoViewer",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_Components_Common_VideoViewer__WEBPACK_IMPORTED_MODULE_1__["default"], {
          attributes: attributes,
          isButton: false
        })
      })]
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/video/style-view"], () => (__webpack_require__("./src/blocks/video/view.js")))
