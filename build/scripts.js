  ...
  $(document).ready(function () {
    ...
    Object.values(panoContainer).map(function (item) {
      ...
      var bppiv_type = settings.bppiv_type,
        ...
        orientation_360 = settings.orientation_360,
        ...
        panorama_format_360 = settings.panorama_format_360,
        haov_360 = settings.haov_360,
        vaov_360 = settings.vaov_360,
        voffset_360 = settings.voffset_360,
        cubemap_front_360 = settings.cubemap_front_360,
        cubemap_right_360 = settings.cubemap_right_360,
        cubemap_back_360 = settings.cubemap_back_360,
        cubemap_left_360 = settings.cubemap_left_360,
        cubemap_up_360 = settings.cubemap_up_360,
        cubemap_down_360 = settings.cubemap_down_360;
      ...
      if (bppiv_type === "video") {
        ...
        var orientation360 = Boolean(parseInt(orientation_360));
        ...
        var isCubemap = panorama_format_360 === "cubemap";
        var isAllFacesUploaded = Boolean(cubemap_front_360 && cubemap_right_360 && cubemap_back_360 && cubemap_left_360 && cubemap_up_360 && cubemap_down_360);
        var titleAuthorOptions = titleAuthor === "1" ? {
          title: title_360,
          author: author_360
        } : {};
        var viewerConfig = _objectSpread(_objectSpread({
          autoLoad: autoLoad,
        ...
        if (isCubemap && isAllFacesUploaded) {
          ...
          viewerConfig.cubeMap = [cubemap_front_360, cubemap_right_360, cubemap_back_360, cubemap_left_360, cubemap_up_360, cubemap_down_360];
        } else if (panorama_format_360 === "cylindrical") {
          var currentHaov = parseFloat(haov_360 !== null && haov_360 !== void 0 ? haov_360 : 360);
          var currentVaov = parseFloat(vaov_360 !== null && vaov_360 !== void 0 ? vaov_360 : 180);
          var currentVOffset = parseFloat(voffset_360 !== null && voffset_360 !== void 0 ? voffset_360 : 0);
