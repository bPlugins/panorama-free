  ...
  $(document).ready(function () {
    ...
    Object.values(panoContainer).map(item => {
      ...
      if (bppiv_type === "video") {
        ...
        const image360 = image_src_360 !== null && image_src_360 !== void 0 ? image_src_360 : "";
        ...
        const titleAuthor = title_author !== null && title_author !== void 0 ? title_author : 0;
        const compass360 = Boolean(parseInt(compass_360));
        const orientation360 = Boolean(parseInt(orientation_360));
        const initialView = Boolean(parseInt(initial_view)) && {
        ...
        const isAllFacesUploaded = Boolean(cubemap_front_360 && cubemap_right_360 && cubemap_back_360 && cubemap_left_360 && cubemap_up_360 && cubemap_down_360);
        const titleAuthorOptions = titleAuthor === "1" ? {
          title: title_360,
          author: author_360
        } : {};
        const viewerConfig = {
        ...
        if (isCubemap && isAllFacesUploaded) {
          ...
          const currentHaov = parseFloat(haov_360 !== null && haov_360 !== void 0 ? haov_360 : 360);
          const currentVaov = parseFloat(vaov_360 !== null && vaov_360 !== void 0 ? vaov_360 : 180);
          const currentVOffset = parseFloat(voffset_360 !== null && voffset_360 !== void 0 ? voffset_360 : 0);
